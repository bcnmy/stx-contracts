...
/**
 * @title P256Verifier
 * @notice This contract is copied from Daimo's P256Verifier contract.
 * https://github.com/daimo-eth/p256-verifier/blob/master/src/P256Verifier.sol
 * The only changes are
 *  - changing ecdsa_verify function's visibility to internal
 *    instead of private for inheritance purposes.
 *  - change compiler version to ^0.8.27 (instead of 0.8.21)
 * 
