...
contract ComposableExecutionTest is TestAccountExecution_Base {
    ...
    function test_ExecuteComposable_Success() public {
        ...
        constraints_input1_1[0] =
            Constraint({ constraintType: ConstraintType.EQ, referenceData: abi.encode(bytes32(input1)) });
        ...
        emptyConstraints = new Constraint[](0);
        ...
        constraints_input2_1[0] =
            Constraint({ constraintType: ConstraintType.EQ, referenceData: abi.encode(bytes32(input1 + 1)) });
