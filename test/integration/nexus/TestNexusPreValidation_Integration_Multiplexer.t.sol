...
import { MockPreValidationHookMultiplexer } from "../../mock/modules/MockPreValidationHookMultiplexer.sol";
...
contract TestNexusPreValidation_Integration_HookMultiplexer is TestModuleManagement_Base {
    ...
    function setUp() public {
        ...
        bytes memory callData = abi.encodeWithSelector(
            IModuleManager.installModule.selector, MODULE_TYPE_VALIDATOR, address(SIMPLE_VALIDATOR), validatorSetupData
        );
