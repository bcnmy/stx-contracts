...
import { ExecLib } from "contracts/lib/erc-7579/ExecLib.sol";
import { ModeLib, ExecutionMode } from "contracts/lib/erc-7579/ModeLib.sol";
import "contracts/types/Constants.sol";
import { Execution } from "erc7579/interfaces/IERC7579Account.sol";
import { ModeCode } from "erc7579/interfaces/IERC7579Account.sol";
...
contract MockMultiModule is IModule {
    ...
    function someFallbackFunction(Execution calldata execution) external {
        IERC7579Account(msg.sender).executeFromExecutor{ value: execution.value }({
            mode: ModeCode.wrap(ExecutionMode.unwrap(ModeLib.encodeSimpleSingle())),
    ...
    function isModuleType(uint256 moduleTypeId) external pure returns (bool) {
        return (moduleTypeId == MODULE_TYPE_HOOK || moduleTypeId == MODULE_TYPE_EXECUTOR
                || moduleTypeId == MODULE_TYPE_VALIDATOR || moduleTypeId == MODULE_TYPE_FALLBACK);
    }
