...
import { ValidationConfig } from "contracts/validators/stx-validator/ConfigManager.sol";

/// @title StxValidator Module Lifecycle Unit Tests
/// @notice Unit tests for onInstall and onUninstall functionality
contract StxValidator_onInstall_onUninstall_Test is StxValidator_Unit_Base_Test {
